...
export default function({expirationTime}:{expirationTime: number}) {
    ...
    return <Tooltip position="bottom" content={`You have ${remainingMins} mins left to complete this lab.`}>
        <div style={{backgroundColor: 'rgb(255 255 255 /  0.2)', borderRadius: '4px', fontSize: '14px', minWidth: '100px', padding: '2px 6px', textAlign: 'center', display: 'flex', alignItems: 'center', gap: '8px'}}>
